...
from src.cate.models.mean_embedding import evaluate_mean_embedding
from src.cate.models.abrevaya import evaluate_abrevaya
...
def get_run_func(mdl_name: str):
    ...
    elif mdl_name == "abrevaya":
        return evaluate_abrevaya
    else:
        raise ValueError(f"name {mdl_name} is not known")


def cate_experiments(configs: Dict[str, Any],
                     dump_dir: Path,
