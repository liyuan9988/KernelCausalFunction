...
from src.sate.models.mean_embedding import evaluate_mean_embedding
from src.sate.models.ate_mean_embedding import evaluate_mean_embedding_ignore_sequence_ate
from src.sate.models.cate_mean_embedding import evaluate_mean_embedding_ignore_sequence_cate
from src.sate.models.DML import evaluate_DML
from src.sate.models.DML_org import evaluate_DML_org
...
def get_run_func(mdl_name: str):
    ...
    elif mdl_name == "ate_mean_embedding":
        return evaluate_mean_embedding_ignore_sequence_ate
    elif mdl_name == "cate_mean_embedding":
        return evaluate_mean_embedding_ignore_sequence_cate
    elif mdl_name == "DML":
        return evaluate_DML
    elif mdl_name == "DML_org":
        return evaluate_DML_org
    else:
        raise ValueError(f"name {mdl_name} is not known")


def sate_experiments(configs: Dict[str, Any],
                     dump_dir: Path,
