...
from src.ate.models.mean_embedding import evaluate_mean_embedding
from src.ate.models.IPW import evaluate_ipw
from src.ate.models.doubly_robust import evaluate_doubly_robust
from src.ate.models.edward_doubly_robust import evaluate_edward_doubly_robust
...
def get_run_func(mdl_name: str):
    if mdl_name == "mean_embedding":
        ...
        return evaluate_ipw
    elif mdl_name == "doubly_robust":
        return evaluate_doubly_robust
    elif mdl_name == "edward_doubly_robust":
        return evaluate_edward_doubly_robust
    else:
        raise ValueError(f"name {mdl_name} is not known")


def ate_experiments(configs: Dict[str, Any],
                    dump_dir: Path,
